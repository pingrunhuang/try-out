<#include "header.ftl"> <div class="row">
    <div class="col-md-12 mt-1"> <div class="float-right">
            <form class="form-inline" action="/create" method="post"> <div class="form-group">
    ...
    <div class="col-md-12 mt-1"> <#list pages>
            <h2>Pages:</h2> <ul>
                <#items as page>
